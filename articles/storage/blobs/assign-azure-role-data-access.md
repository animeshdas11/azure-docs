...
> [!NOTE]
> You can also make your own Azure custom roles for the access of blob data. For information about Azure custom roles, see [https://docs.microsoft.com/en-us/azure/role-based-access-control/custom-roles]
